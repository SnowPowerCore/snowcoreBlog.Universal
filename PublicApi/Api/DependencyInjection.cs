    ...
    public static partial class IServiceCollectionExtensions
    {
            ...
            Action<IApizrExtendedCommonOptionsBuilder> optionsBuilder)
        {
            ...
            return services.AddApizr(
                registry => registry
                  .AddManagerFor<IAntiforgerytokenApi>()
                  .AddManagerFor<ICaptchaApi>()
                  .AddManagerFor<ICheckApi>()
                  .AddManagerFor<ICreateApi>()
                  .AddManagerFor<ILoginApi>()
                  .AddManagerFor<IRequestApi>(),
                optionsBuilder);
