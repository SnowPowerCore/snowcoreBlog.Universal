...
namespace snowcoreBlog.PublicApi.Api
{
    ...
    public partial interface ICheckApi
    {
        ...
        Task<ApiResponse> CheckNickNameNotTaken([Body, AliasAs("CheckNickNameNotTakenDto")] CheckNickNameNotTakenDto checkNickNameNotTakenDto, [RequestOptions] IApizrRequestOptions options);
    }
