...
namespace snowcoreBlog.PublicApi.Api
{
    ...
    public partial interface ILoginApi
    {
        ...
        Task<ApiResponse> LoginByAssertion([Body, AliasAs("LoginByAssertionDto")] LoginByAssertionDto loginByAssertionDto, [RequestOptions] IApizrRequestOptions options);
    }
