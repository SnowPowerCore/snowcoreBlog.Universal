...
public sealed class RequestAttestationOptionsForLoginValidation : AbstractValidator<RequestAttestationOptionsForLoginDto>
{
    public RequestAttestationOptionsForLoginValidation()
    {
